                ...
                <div style="display: flex;justify-content: space-between;">
                    ...
                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="width: 82vw;left: -457px;top: 164px;">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="exampleModalLabel">Edit Transfer Type</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                                ...
                                                <div class="col-4 w-100">
                                                    ...
                                                    <div data-v-b1d61d26="" class="d-flex"
                                                        ...
                                                        <div class="form-group mr-2 w-50">
                                                            ...
                                                            <Field type="text" class="form-control" id="exampleInputEmail1"
                                                                aria-describedby="emailHelp" placeholder="trainingType Name"
                                                                v-model="edittrainingType.title" name="edittitle"
                                                                :class="{ 'is-invalid': errors.edittitle }" />

                                                            <div class="invalid-feedback">{{ errors.edittitle }}</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table text-center" id="datatable">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in transferTypeList" :key="index">
                                    <td>{{ item.id }}</td>
                                    <td>{{ item.title }}</td>
                                    <td>
...
export default {
    ...
    data() {
        ...
        const schema = Yup.object().shape({
            title: Yup.string().required("trainingType Name is required"),
            status: Yup.string().required("Status is required"),
        });

        const editschema = Yup.object().shape({
            edittitle: Yup.string().required("trainingType Name is required"),
    ...
    methods: {
        deleterecord(id) {
            this.axios
                .delete(this.backend_url + 'deleteTransferType/' + id)
                .then((res) => {
        ...
        EdittrainingType() {
            try {
                this.axios
                    .post(this.backend_url + `updateTransferType/${this.edittrainingType.id}`, this.edittrainingType)
                    .then((res) => {
                        console.log(res);
                        this.getTransferTypeList();
        ...
        getTransferTypeList() {
            this.axios
                ...
                .then((res) => {
                    ...
                    this.transferTypeList = res.data.list;
                    setTimeout(function () {
                        $("#datatable").DataTable({
                            "processing": true,
                        });
        ...
        editbutton(id) {
            console.log(id);
            this.axios
                .get(this.backend_url + 'specificTransferType/' + id)
                .then((response) => {
                    ...
                    this.edittrainingType.title = this.transferRecordById.title;
        ...
        activestatus(id) {
            this.axios
                .patch(this.backend_url + `activeTransferType/${id}`)
                .then((response) => {
        ...
        inactivestatus(id) {
            this.axios
                .patch(this.backend_url + `inactiveTransferTypeRecord/${id}`)
                .then((response) => {
                    console.log(response);
                    this.getTransferTypeList();
                    $('#datatable').DataTable().destroy();
        ...
        savetrainingType() {
            try {
                ...
                this.edit = false;
                this.axios
                    .post(this.backend_url + 'addTransferType', this.trainingType)
                    .then((res) => {
                        console.log(res);
                        this.getTransferTypeList();
