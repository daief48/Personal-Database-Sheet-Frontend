        ...
        <div class="row">
          <div class="col-md-12">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="pills-emergency-other" data-toggle="pill" href="#emergency-other" role="tab"
                  aria-controls="pills-emergency-other" aria-selected="false">Documents</a>
              </li>
            </ul>
                            ...
                            <table class="table table-borderless d-flex">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <Field type="number" v-model="education.passing_year" class="form-control"
                      ...
                      <table class="table table-borderless d-flex">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <Field type="text" v-model="freedomFighter.fighting_divi" class="form-control"
                    ...
                    <div v-for="(value, key) in document" :key="key">
                      <div class="d-flex flex-row p-3 card">
                        <div class="w-50 border">
                          <div class="mt-3 p-3  h-100">
                            <input class="form-control" v-model="value.document_name" placeholder="Document Name">
                          </div>
                        </div>
                        <div class="col-md-3 border">
                          <div class="mt-3 p-3  d-flex flex-column align-items-center row h-100 ">

                            <span v-if="value.document_file" class="badge badge-secondary"> <a target="blank" :href="'http://localhost/pds-backend/public/document_files/' + value.document_file" style="color:white;" >{{ value.document_file
                            }}</a> </span>
                        ...
                        <div class="w-25 d-flex justify-content-center align-items-center">
                          <button class="btn btn-danger mt-2" @click="deleteField(key)">
                            Delete
                          </button>
                        </div>
                      </div>
...
export default {
  ...
  methods: {
    ...
    changePresentDistrict() {
      ...
      this.present_district.district = this.addressDetails.present_addr_district === null ? '' : this.addressDetails.present_addr_district;
    },
    changePresentupazila() {
      console.log(this.addressDetails.present_addr_district)
      this.present_addr_upazila.upazila = this.addressDetails.present_addr_upazila === null ? '' : this.addressDetails.present_addr_upazila;
    },
    changePermanentDistrict() {
      console.log(this.addressDetails.present_addr_district)
      this.permanent_addr_district.district = this.addressDetails.permanent_addr_district === null ? '' : this.addressDetails.permanent_addr_district;
    },
    changePermanentUpazila() {
      console.log(this.addressDetails.present_addr_district)
      this.permanent_addr_upazila.upazila = this.addressDetails.permanent_addr_upazila === null ? '' : this.addressDetails.permanent_addr_upazila;
    },
    ...
    handleFileChange(event, index) {
      ...
      this.axios
        .post(this.backend_url + 'user/fileUpload', formData, {
          headers: {
    ...
    setData() {
      ...
      this.imgDataUrl =
        ...
        this.imgDataUrl = this.data.image !== null ? this.base_url_for_resource + 'images/' + this.data.image : '';
      ...
      this.educationArr = this.data.education_history === null ? [] : JSON.parse(this.data.education_history);
